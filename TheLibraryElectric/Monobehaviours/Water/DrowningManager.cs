...
namespace TheLibraryElectric.Water
{
    ...
    {
        public Il2CppValueField<float> timeUntilDrowning = 20f;
        public Il2CppValueField<float> damageInterval = 1f;
        public Il2CppValueField<float> damagePercentage = 0.10f;
