...
namespace TheLibraryElectric.Water
{
    public class WaterZone : MonoBehaviour
    {
        ...
        public Il2CppValueField<float> buoyancyMultiplier = 1.0f; // Adjust this to control the buoyancy threshold.
        public Il2CppValueField<float> midpoint = 50.0f; // Adjust this to control the midpoint of the effect.
        public Il2CppValueField<bool> midpointSink = true; // Will masses at the midpoint sink or float?
        public Il2CppValueField<bool> dampening = true; // If dampening is enabled, drag will increase as the object sinks.
        public Il2CppValueField<float> dampeningAmount = 0.98f; // Dampening multiplier
